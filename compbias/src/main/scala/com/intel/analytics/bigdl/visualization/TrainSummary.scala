...
class TrainSummary(
  ...
  def setSummaryTrigger(tag: String, trigger: Trigger): this.type = {
    require(tag.equals("LearningRate") || tag.equals("Loss") || tag.equals("Iterationdelratio") ||
      tag.equals("Timeratio") || tag.equals("CompMean") || tag.equals("TrainMean") ||
      tag.equals("Throughput") | tag.equals("Parameters"),
      s"TrainSummary: only support LearningRate, Loss, Parameters and Throughput Iterationdelratio Timeratio")
